...
TEST_CA_FILE=RSACA
TEST_CA_DN="/C=CN/ST=BJ/L=HaiDian/O=Beijing YSP Technology LTD./OU=SORB of YSP/CN=Test CA (RSA-sha256)"

TEST_SERVER_KEYSIZE=2048
TEST_SERVER_KEYFILE=SSKEY
TEST_SERVER_FILE=SSign
TEST_SERVER_DN="/C=CN/ST=BJ/L=HaiDian/O=Beijing YSP Technology LTD./OU=BSRC of YSP/CN=server sign (RSA-sha256)"

TEST_SERVER_ENC_FILE=SEnc
TEST_SERVER_ENC_KEYFILE=SEKEY
TEST_SERVER_ENC_DN="/C=CN/ST=BJ/L=HaiDian/O=Beijing YSP Technology LTD./OU=BSRC of YSP/CN=server enc (RSA-sha256)"

TEST_CLIENT_KEYSIZE=2048
TEST_SERVER_KEYFILE=CSKEY
TEST_CLIENT_FILE=CSsign
TEST_CLIENT_DN="/C=CN/ST=BJ/L=HaiDian/O=Beijing YSP Technology LTD./OU=BSRC of YSP/CN=client sign (RSA-sha256)"

TEST_CLIENT_ENC_FILE=CEnc
TEST_CLIENT_ENC_KEYFILE=CEKEY
TEST_CLIENT_ENC_DN="/C=CN/ST=BJ/L=HaiDian/O=Beijing YSP Technology LTD./OU=BSRC of YSP/CN=client sign (RSA-sha256)"
